...
const RunException = function() {
	...
	service.login(function(err,sucess){
		...
		var searchQuery = 'search host=*ulv*ppysh* source=*bankcard* Exception NOT PING | table host | stats count by host| sort host'
...
const RunTraffic= function() {
	...
	service.login(function(err,sucess){
		...
		var searchQuery = 'search host=*ulv*ppysh* source=*bankcard* NOT Exception | table host | stats count by host| sort host'
